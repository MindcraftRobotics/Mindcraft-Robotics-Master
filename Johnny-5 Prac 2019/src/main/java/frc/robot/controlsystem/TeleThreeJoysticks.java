...
public class TeleThreeJoysticks
{
    ...
    {
        if(coDriver.getRawButton(Constants.JoystickCodriver.Buttons.cargoIn))
        {
            robosystem.front_intake.setCargoPower(-1.0);
        }else if(coDriver.getRawButton(Constants.JoystickCodriver.Buttons.cargoOut))
        {
            robosystem.front_intake.setCargoPower(1.0);
        }else
        {
        ...
        if(coDriver.getRawButton(Constants.JoystickCodriver.Buttons.wristIn)) {
            robosystem.front_intake.setCargoPower(-1.0);
        }else if(coDriver.getRawButton(Constants.JoystickCodriver.Buttons.wristOut)){
            robosystem.front_intake.setCargoPower(1.0);
        }else {
            robosystem.front_intake.setCargoPower(0.0);
        }
