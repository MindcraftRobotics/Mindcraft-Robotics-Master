...
public class Drivetrain
{
    ...
    private Drivetrain()
    {
        ...
        drivetrain_rightMaster.configPeakOutputForward(.50, 10);
        drivetrain_rightMaster.configPeakOutputReverse(-.50, 10);
        drivetrain_leftMaster.configPeakOutputForward(.50, 10);
        drivetrain_leftMaster.configPeakOutputReverse(-.50, 10);
